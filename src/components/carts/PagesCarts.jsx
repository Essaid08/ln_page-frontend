...
const PagesCarts = ({svgIcon1 , header1 , linkto1 , svgIcon2 , header2 , linkto2}) => {
	return (
		<section id="carts" className='w-full flex flex-col gap-10 pt-20 pb-24  justify-center items-center max-w-[1580px] px-7 md:px-16 lg:px-20 xl:px-32  text-[#151811]  dark:text-[#f7fef9]'>
