...
const Facts = ({header1 , firstPara , header2 , secondePara}) => {
	return (
		<article className='w-full flex flex-col gap-2 text-[#151811]   dark:text-[#f7fef9] pb-12  justify-between items-center max-w-[1580px] px-12 md:px-16 lg:px-20 xl:px-32  md:items-start '>
